            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu border-0 shadow-sm mt-2">
                        ...
                        <li><a class="dropdown-item small text-muted" href="search.php">Alle Rezepte durchsuchen</a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="d-flex align-items-center">
                <form class="d-flex me-3" action="search.php" method="GET">
                    <div class="input-group input-group-sm search-group-custom">
                        <input class="form-control search-input-custom" type="search" name="query"
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm mt-3">
                        <?php if (isset($_SESSION['userid'])): ?>
                            ...
                            <li><a class="dropdown-item" href="my_recipes.php"><i class="bi bi-journal-text me-2"></i>Meine
                                    Rezepte</a></li>
                            <li><a class="dropdown-item" href="favorites.php"><i class="bi bi-heart me-2"></i>Merkliste</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item text-danger" href="logout.php"><i
                                        class="bi bi-box-arrow-right me-2"></i>Abmelden</a></li>
                        <?php else: ?>
                            <li class="p-2"><a class="btn btn-primary btn-sm w-100 rounded-pill mb-1"
                                    href="login.php">Anmelden</a></li>
                            <li class="p-2"><a class="btn btn-outline-dark btn-sm w-100 rounded-pill"
