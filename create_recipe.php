            ...
            <div class="col-md-8">
                ...
                <?php if ($success): ?>
                    <div class="card shadow-sm border-0 rounded-4 p-5 text-center">
                        ...
                        <div class="mt-4">
                            <a href="recipe.php?id=<?= $idNewRecipe ?>" class="btn btn-primary rounded-pill px-4">Zum
                                Drink</a>
                    ...
                    <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                        ...
                        <form action="create_recipe.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="recipe_name" class="form-control border-0 bg-light py-3 rounded-3"
                                    placeholder="z.B. Gin Basil Smash" required>
                            </div>

                            <div class="mb-4">
                                <label class="small fw-bold text-muted text-uppercase">Kurze Beschreibung</label>
                                <textarea name="description" class="form-control border-0 bg-light py-3 rounded-3" rows="2"
                                    placeholder="Was macht diesen Cocktail besonders?"></textarea>
                            </div>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="form-check small">
                                                <input class="form-check-input" type="checkbox" name="categories[]"
                                                    value="<?= $cat['category_id'] ?>" id="c<?= $cat['category_id'] ?>">
                            ...
                            <div class="mb-4 p-4 bg-white border rounded-4">
                                <label class="small fw-bold text-muted mb-3 d-block text-uppercase">Zutaten (Max.
                                    15)</label>
                                <?php for ($i = 1; $i <= 15; $i++): ?>
                                    <div class="row g-2 mb-2">
                                        <div class="col-3">
                                            <input type="number" step="0.1" name="ing_amount[]"
                                                class="form-control border-0 bg-light py-2 rounded-3 text-center"
                                                placeholder="Menge">
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-6">
                                            <input type="text" name="ing_name[]"
                                                class="form-control border-0 bg-light py-2 rounded-3"
                                                placeholder="Zutat <?= $i ?>">
                                        </div>
                                    </div>
                                <?php endfor; ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="steps" class="form-control border-0 bg-light py-3 rounded-3" rows="6"
                                    placeholder="1. Eis in das Glas geben...&#10;2. Zutaten verrühren..."
                                    required></textarea>
                            </div>

                            <div class="mb-5">
                                <label class="small fw-bold text-muted text-uppercase">Fotos</label>
                                <input type="file" name="image[]" class="form-control border-0 bg-light py-3 rounded-3"
                                    multiple>
                            </div>

                            <button type="submit"
                                class="btn btn-primary w-100 py-3 rounded-pill fw-bold shadow-sm">SPEICHERN &
